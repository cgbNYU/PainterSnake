...
// BRUSH TYPES. Implement your own here
        ...
        public void PaintBrush(Vector2 world_position)
        {
            // 1. Change world position to pixel coordinates
            Vector2 pixel_pos = WorldToPixelCoordinates(world_position);
...
//////////////////////////////////////////////////////////////////////////////
        ...
        public void ColourBetween(Vector2 start_point, Vector2 end_point, int width, Color color)
        {
            ...
            for (float lerp = 0; lerp <= 1; lerp += lerp_steps)
            {
                ...
                MarkSpriteToColour(cur_position, width, color);
            }
        }


        //Function to take a sprite and draw it
        public void MarkSpriteToColour(Vector2 center_pixel, int pen_thickness, Color color_of_pen)
        {
        ...
        public void MarkPixelToChangeSprite(int x, int y, Color color)
        {
